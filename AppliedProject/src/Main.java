...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String plainText = timeGen.messageGuess();
        System.out.println("Original message: " + plainText);

        try (java.io.FileWriter writer = new java.io.FileWriter("guess_message.txt")) {
            writer.write(plainText);
        } catch (Exception e) {
            System.err.println("Failed to save guess message: " + e.getMessage());
        }
        ...
        int[] rotors = {positionA, positionB, positionC};
            ...
            for (int i = 0; i < inputArray.length; i++) {
                ...
                if (rotors[0] > 25) {
                    ...
                    if (rotors[1] > 25) {
                        rotors[1] = 0;
                        rotors[2]++;
                        if (rotors[2] > 25) rotors[2] = 0;
                    }
                }
            }

            String encryptedResult = String.valueOf(encryptedArray);
